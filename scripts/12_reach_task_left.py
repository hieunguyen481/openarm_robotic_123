"""Run a complete left-arm reach task episode."""
...
print("\n".join(lines))
(OUTPUT_DIR / "reach_task_left.txt").write_text("\n".join(lines), encoding="utf-8")
np.savez_compressed(
    OUTPUT_DIR / "reach_task_left.npz",
    target_pos=target_pos,
    start_pos=start_pos,
    final_pos=final_pos,
    distance_history=result.distance_history,
    left_ee_pos_history=result.ee_pos_history,
...
print("\nSaved to outputs/reach_task_left.txt")
print("Saved to outputs/reach_task_left.npz")
