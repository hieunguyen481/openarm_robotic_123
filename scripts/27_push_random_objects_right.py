"""Run push robustness trials for random right-side cube positions."""
...
np.savez_compressed(
    OUTPUT_DIR / "push_random_right_summary.npz",
...
print("\n".join(lines))
write_lines(OUTPUT_DIR / "push_random_right_summary.txt", lines)
print("\nSaved to outputs/push_random_right_summary.txt")
print("Saved to outputs/push_random_right_summary.npz")
